package io.github.wendergalan.auth;

import io.github.wendergalan.auth.entities.Permission;
import io.github.wendergalan.auth.entities.User;
import io.github.wendergalan.auth.repositories.PermissionRepository;
...
public class AuthApplication {
    ...
    private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
        ...
        User admin = new User();
        admin.setUserName("wendergalan");
        admin.setAccountNonExpired(true);
        admin.setAccountNonLocked(true);
        admin.setCredentialsNonExpired(true);
        admin.setEnabled(true);
        admin.setPassword(passwordEncoder.encode("123456"));
        admin.setPermissions(Collections.singletonList(permission));

        User find = userRepository.findByUserName("wendergalan");
        if (find == null)
